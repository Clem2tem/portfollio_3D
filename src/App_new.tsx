...
function App() {
  const [currentView, setCurrentView] = useState<'intro' | 'home' | '3d'>('intro')
    ...
    <LoadingProvider>
      <ProjectViewProvider>
        <PlayerPositionProvider>
          <div className="w-full h-screen relative overflow-hidden" style={{ cursor: currentView === 'intro' ? 'auto' : 'none' }}>
            
            {/* Intro Screen */}
            {currentView === 'intro' && (
              <IntroScreen onEnterPortfolio={handleEnterFromIntro} />
            )}
